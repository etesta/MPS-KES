...
% 	 \small \url{e.testa@ipnl.in2p3.fr}
 }
...
Ion-range monitoring by means of prompt gammas (PG) detection is currently investigated for hadrontherapy verification. These PG emitted during the irradiation can be detected with various systems, such as collimated and Compton cameras [1]. From a general point of view, the performances of collimated cameras are mainly determined by a compromise between spatial resolution and detector efficiency. 
}
