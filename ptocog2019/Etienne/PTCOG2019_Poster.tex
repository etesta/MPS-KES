			...
			\end{figure}
				...
				\begin{column}{0.49\textwidth}
					...
					\begin{tabular}{lcc}
						...
						\midrule
					\end{tabular}
					\caption{Detection efficiencies (DE) and spatial resolution (Res=FOW) predicted by the analytical model. FOW: Fall-Off Width of the PG profile (see \enquote{Figures of merit}) ; $s_e$: effective slit width ; $T_e$: Collimator effective thickness. }
					\end{table}
...
% 			\end{table}			
	...
	\begin{block}{8. Discussion and conclusion}	
		\begin{itemize}
			...
			\begin{itemize}
				\item PG profiles: MPS prototype with larger fall-off amplitude and lower BKG level thanks to larger energy and TOF selections, respectively
