...
\begin{figure}[htp]
    ...
    \caption{\label{GeomFormulas} MPS and KES detection efficiencies and spatial resolution from geometrical considerations. The parameters of the cameras are defined in figure~\ref{GeomSchemes}.  }
  \end{figure}
...
For the validation of the theoretical expressions in table~\ref{GeomFormulas}, the two cameras are equalized by settings the absorber material to LYSO in the MPS camera and the PG energy selection window to 1-8 MeV.
