...
\tcb{Etienne: todo => Explain the context of PG verifications: detection of PG profiles obtained at the scale of a spot or several spots => line source in which we mainly look for edges (entrance rise and fall-off in the Bragg peak region)}
...
% \tcb{The previous paragraph refers to the verification of our simulations and data analysis by comparing the FOP with the results published in Perali, right ? It is presented in Appendix }
