...
% Priegnitz et al. have shown that the KES prototype is not able to detect the
% filling of a cavity located 5 mm upstream to the Bragg peak position [Priegnitz
% PMB 2015].

%Other parameters: Energy and TOF cuts.
